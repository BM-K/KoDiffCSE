...
class Arguments():
    ...
    def add_type_of_processing(self):
        ...
        self.add_argument('--generator_name', type=str, default='klue/bert-base')
    ...
    def add_hyper_parameters(self):
        ...
        self.add_argument('--lambda_weight', type=float, default=0.005)
        self.add_argument('--masking_ratio', type=float, default=0.15)
        self.add_argument('--max_len', type=int, default=64)
        self.add_argument('--batch_size', type=int, default=256)
        self.add_argument('--epochs', type=int, default=2)
        self.add_argument('--eval_steps', type=int, default=125)
